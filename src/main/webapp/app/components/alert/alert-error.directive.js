(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('boncmd2App.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                ...
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('boncmd2App.' + fieldError.objectName + '.' + convertedField);
